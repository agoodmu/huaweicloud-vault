...
const backendHelp = `
The hwc secrets backend dynamically generates user tokens.
...
func backend() *hwcBackend {
	...
	b.Backend = &framework.Backend{
		...
		Paths:       framework.PathAppend(pathRole(&b), []*framework.Path{pathConfig(&b), pathCredentials(&b)}),
		Secrets:     []*framework.Secret{b.hwcToken()},
